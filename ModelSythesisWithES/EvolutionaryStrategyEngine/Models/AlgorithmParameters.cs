...
namespace EvolutionaryStrategyEngine.Models
{
    public class AlgorithmParameters
    {
        ...
        public AlgorithmParameters(double globalLerningRate, double individualLearningRate, double stepThreshold, double rotationAngle, int objectVectorSize, MutationType typeOfMutation)
        {           
